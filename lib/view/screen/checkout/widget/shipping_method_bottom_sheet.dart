                    ...
                    if(snapshot.connectionState == ConnectionState.waiting){
                      ...
                      return SizedBox(
                        child: Column(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          CustomButton(buttonText: '${getTranslated('select', context)}', onTap: (){
                            setState(() {
                              if (_selectedShippingList.isNotEmpty) {
                                // If a shipping method is selected, pop the modal and send back the selected method
                                Navigator.pop(context, _selectedShippingList[0]);
                              } else {
                                // If no shipping method is selected, show an error message or handle it accordingly
