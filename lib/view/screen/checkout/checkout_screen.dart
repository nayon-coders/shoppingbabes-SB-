...
class CheckoutScreen extends StatefulWidget {
  ...
  final int quantity;
  final String shipingMethodId;
  final Map<String, dynamic> selectedDeliveryMethod;
                  ...
                  onTap: () async {
                    if (orderProvider.addressIndex == null &&
                      ...
                      for (int index = 0; index < widget.cartList.length; index++) {
                        for (int i = 0; i < cartProvider.chosenShippingList.length; i++) {
                          if (cartProvider.chosenShippingList[i].cartGroupId == widget.cartList[index].cartGroupId) {
                            ...
                            shipingMethodId = cartProvider.chosenShippingList[i].shippingMethodId;
                            break;
                          }
                        }
                      }
                      ...
                      if (orderProvider.paymentMethodIndex != -1) {
                        print("click here === ${shipingMethodId}");
                        orderProvider.digitalPayment(
                            ...
                            shippingCost: widget.shippingFee.toString(),
                          shippingId: widget.shipingMethodId
                          );
                      }
                    ...
                    children: [
                      Padding(
                          ...
                          child: ShippingDetailsWidget(
                              isRider: widget.selectedDeliveryMethod["title"].toString().toLowerCase().contains("rider") ? true : false,
